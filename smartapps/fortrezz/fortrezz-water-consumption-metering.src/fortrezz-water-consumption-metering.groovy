...
// I created my own more simple notification system which seems to work just fine. If the features included in the commented out code below are needed, I didn't want to erase them.
/*
