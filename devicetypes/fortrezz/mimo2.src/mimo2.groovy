...
metadata {
    ...
    preferences {
        input "RelaySwitchDelay", "decimal", range: "0..3.1", title: "Relay 1 Delay between relay switch on and off in seconds. Only Numbers 0 to 3.1 allowed. 0 value will remove delay and allow relay to function as a standard switch", description: "Numbers 0 to 3.1 allowed.", defaultValue: 0, required: false, displayDuringSetup: true
    
        //input ("RelaySwitchDelay2", "decimal", range: "0..3.1", title: "Relay 2 Delay between relay switch on and off in seconds. Only Numbers 0 to 3.1 allowed. 0 value will remove delay and allow relay to function as a standard switch", description: "Numbers 0 to 3.1 allowed.", defaultValue: 0, required: false, displayDuringSetup: true)
    }
...
{
	log.debug "sent a SwitchBinary command"
	refresh()    
	return [name: "contact", value: cmd.value ? "open" : "closed"]
}
